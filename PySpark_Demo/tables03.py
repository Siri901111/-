...
# 1.创建SparkSession
spark = SparkSession.builder.appName("tables03_task").getOrCreate()
...
tables03_sql='''
                        ...
                        select flight_type1,count(1) num
                        from ods_flight
...
'''
spark.sql(tables03_sql).show()
spark.sql(tables03_sql).write.jdbc(mysql_url, 'tables03', 'overwrite', prop)