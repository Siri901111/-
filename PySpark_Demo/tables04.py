...
# 1.创建SparkSession
spark = SparkSession.builder.appName("tables04_task").getOrCreate()
...
'''
spark.sql(tables04_sql).show()
spark.sql(tables04_sql).write.jdbc(mysql_url, 'tables04', 'overwrite', prop)